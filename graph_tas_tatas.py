...
plt.errorbar(X, means1, stds1, fmt='.-', capsize=5, ecolor='black', label="Test and set")
plt.errorbar(X, means2, stds2, fmt='.-', capsize=5, ecolor='grey', label="Test and test and set")
...
plt.grid(True)
plt.title("Evaluation de test_and_set et test_and_test_and_set")
plt.legend()
